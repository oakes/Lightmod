...
Xe.setTextContent=function(a){return Re(document.querySelector("#content"),a)};Xe.getTextContent=Ve;Xe.getSelectedText=function(){return null};Xe.markClean=We;Xe.isClean=function(){var a=C(Se);a=null==a?null:se.c(a);return null==a?null:O.f(a,Ve())};Xe.changeTheme=function(a){var b=C(Se);b=null==b?null:ve.c(b);return null==b?null:b.setOption("theme",r(a)?"lesser-dark":"default")};Xe.setTextSize=function(a){return document.querySelector(".CodeMirror").style.fontSize=[w.c(a),"px"].join("")};
